...
class TestAgenticLoop:
    ...
    def test_run_agentic_loop_with_tool_call(self, mock_execute_tool, MockGroq, session):
        ...
        mock_execute_tool.return_value = json.dumps({"status": "email_saved", "email": "test@example.com"})
    ...
    def test_run_agentic_loop_max_iterations(self, mock_execute_tool, MockGroq, session):
        ...
        assert response_text == "I'm sorry, I wasn't able to process your request. Please try again."
