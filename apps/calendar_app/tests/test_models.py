...
class TestBookingModel:
    def test_create_booking_with_email(self):
        ...
        booking = Booking.objects.create(
            ...
            start_time=datetime.datetime(2026, 8, 1, 10, 0, tzinfo=datetime.timezone.utc),
            end_time=datetime.datetime(2026, 8, 1, 10, 30, tzinfo=datetime.timezone.utc),
            reason="Test booking",
        )
    ...
    def test_multiple_bookings_same_email_allowed(self):
        ...
        for i in range(3):
            Booking.objects.create(
                ...
                start_time=datetime.datetime(2026, 8, i + 1, 10, 0, tzinfo=datetime.timezone.utc),
                end_time=datetime.datetime(2026, 8, i + 1, 10, 30, tzinfo=datetime.timezone.utc),
            )
    ...
    def test_google_event_id_is_unique(self):
        ...
        with pytest.raises(IntegrityError):
            Booking.objects.create(
                email="b@example.com",
                google_event_id="unique_evt",
                start_time=datetime.datetime(2026, 8, 2, 10, 0, tzinfo=datetime.timezone.utc),
                end_time=datetime.datetime(2026, 8, 2, 10, 30, tzinfo=datetime.timezone.utc),
            )
